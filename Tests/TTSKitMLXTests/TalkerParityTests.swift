...
final class TalkerParityTests: XCTestCase {
    ...
    // Serial XCTest execution guards these caches; Swift 6 strict concurrency
    // can't see that, hence the explicit opt-out.
    nonisolated(unsafe) static var talker: Talker?
    nonisolated(unsafe) static var codecEmbedding: MLXArray?
